...
const sections = [
  ...
  { title: "2. Anmeldung & Verbindlichkeit", body: "Buchungen über www.l-me.ch oder telefonisch sind verbindlich. Mit der Buchung akzeptierst du diese AGB vollumfänglich." },
  { title: "3. Preise & Zahlung", body: "Alle Preise in Schweizer Franken (CHF) inkl. MwSt. Zahlung per Bar, Banküberweisung oder online. Bei Zahlungsverzug wird eine Bearbeitungsgebühr von CHF 30.– sowie ein Verzugszins von 5% verrechnet." },
  { title: "4. Absagen & Stornierungen", body: "Absagen müssen mindestens 24 Stunden vor dem Termin mitgeteilt werden (telefonisch oder per E-Mail). Bei kurzfristiger Absage oder Nichterscheinen wird die Lektion vollständig in Rechnung gestellt. Ausnahme: Arztzeugnis, innerhalb von 5 Tagen einzureichen." },
  ...
  { title: "7. Prüfungsanmeldung", body: "Die Anmeldung zur Führerprüfung erfolgt durch die Fahrschule me in Absprache mit dem Fahrschüler, sobald Prüfungsreife erreicht ist." },
  { title: "8. Verhaltensregeln", body: "Die Fahrschule me behält sich das Recht vor, Fahrschüler bei Verstoss gegen die Verhaltensregeln ohne Rückerstattung von der Ausbildung auszuschliessen." },
  { title: "9. Anwendbares Recht", body: "Es gilt Schweizer Recht. Gerichtsstand: Wettingen, Kanton Aargau." },
];
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-3xl mx-auto px-6 py-12 font-body text-foreground">
        ...
        <p className="text-primary font-heading font-bold uppercase tracking-wide text-sm mb-8">Fahrschule me • Stand: Mai 2026</p>
