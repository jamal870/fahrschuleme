  ...
  <Html lang="de" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        {/* Header with logo and cyan accent bar */}
...
// ── Styles — matches the real site brand (see src/index.css --primary: 195
// 90% 55% ≈ #25C0F4, font-heading "Sora" / font-body "Manrope",
// public/logo-lme.png) instead of the old orange/navy scheme.
const CYAN = '#25c0f4'
