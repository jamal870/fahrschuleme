...
Deno.serve(async (req) => {
  ...
  // Defense in depth: only service-role callers may trigger queue processing.
  // Der Service-Key kann ein JWT (legacy) oder ein opakes Secret (sb_secret_…)
  // sein – beide Varianten werden akzeptiert.
