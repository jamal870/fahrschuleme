...
- **🔒 FREEZE v1.5.2 (2026-06-20):** Admin Teilnehmer-Verwaltung + Chatbot/Fahrstunden same-tab Redirects + Admin-Tabs visuell verstärkt (fett, orange aktiv, umrandet). Keine Code-Änderungen ohne ausdrückliche Freigabe. Siehe VERSION.md.
